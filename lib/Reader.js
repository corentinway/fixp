...
function Reader( options ) {
     ...
     *      name                                description
     *
     *      'final-parsing'                     when all the stream was parsed
     *      'fieldNotFoundError'                when a field was not found
     *      'read-field'                        when a field is read
     *      'read-header'                       when a field is read for the header
     *      'message-type'                      when the message type is read
     *      'group-start'                       when we start reading a group
     *      'new-repeating-group-element'       when we end reading a repeating group element
     *      'group-field'                       when a field in a group is found
     *      'group-end'                         when we end reading a repeating group
     *      'read-body'                         when a field is read for the body
     *      'read-trailer'                      when a field is read for the trailer
     *
     */
    var listeners = [];
